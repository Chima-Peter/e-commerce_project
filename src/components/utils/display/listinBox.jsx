...
function ListinBox({car, index, show}) {
  return (
   <>
      <img src={car['carImage']} alt="" rel="preload" fetchPriority="low" className={`rounded-t-lg bg-contain ${!show ? 'w-[150px] h-[100px] md:w-[180px]' : 'min-w-[250px] h-[100px] md:min-w-[300px] md:h-[150px]'}`} />
